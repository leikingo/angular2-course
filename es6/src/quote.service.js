...
// using javascript modules we need to export the class for usage in other files
// the sampleQuotes are not exported and therefore not available in other files
  ...
  export class QuoteService {
    ...
    getRandomQuote() {
      // let, const is block scoped, var function scoped
      // const does not allow change, should be prefered 
    ...
    generateRandomQuotes(delay, callback) {
      ...
      // instead of callback functions we can use the bold arrow syntax
