...
export class QuoteService {
  ...
  // per default all properties and methods are public
  ...
  // callbacks are declared via bold arrow syntax.
  // although getRandomQuote did NOT specifies the returned type, the compiler uses type inference
  // an object with the properties "line" and "author" is compatible with the Quote interface
  // nevertheless the types should be specified
